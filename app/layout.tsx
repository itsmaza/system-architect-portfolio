...
/* ═══════════════════════════════════════════════════════════════
   ...
   Inter → --font-geist-sans (CSS variable name used by Tailwind)
   JetBrains Mono → --font-geist-mono
   
   These variables get injected as className on <html>,
   then picked up by @theme in globals.css via var(--font-geist-sans)
   ═══════════════════════════════════════════════════════════════ */
...
const SITE_DESCRIPTION =
  "Full Stack Software Engineer specializing in scalable distributed systems, high-performance architectures, React, Next.js, Node.js, and cloud-native solutions. Building production-grade applications with clean code and algorithmic precision.";
...
export const metadata: Metadata = {
  ...
  icons: {
    ...
    apple: [
      { url: "/binary.png", sizes: "180x180", type: "image/png" },
    ],
    shortcut: "/binary.png",
  },
